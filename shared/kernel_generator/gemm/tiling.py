...
Usage::
    ...
    from kernel_generator.gemm.tiling import GemmTiling, TileDim, S
...
class GemmTiling:
    ...
    swizzle: object = None     # Swizzle instance (overrides lds_swizzle)
    ...
    def from_tile_config(tile: TileConfig) -> GemmTiling:
        ...
        t.swizzle = getattr(tile, "swizzle", None)
        return t
